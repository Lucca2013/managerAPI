 ...
 */
export declare function parse<T extends PathBuilder | string>(path: T): T extends PathBuilder<infer U> ? ParsedPath<U> : T extends string ? ParsedPath<T> : never;
/**
 * Pluck the root of a path.
 */
export type PathRoot<T extends string> = T extends `/${string}` ? "/" : T extends `${infer Root}:${string}` ? `${Root}:` : "";
/**
