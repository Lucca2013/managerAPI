 ...
 */
export type PluckBasename<T extends string, D extends PathDelimiter = "/"> = Split<WithoutTrailingDelimiter<T, D>, D> extends [...infer _Head, infer Tail] ? Tail extends string ? Tail : never : never;
/**
 ...
 */
export declare function basename<T extends PathBuilder | string>(path: T): T extends PathBuilder<infer U> ? PathBuilder<PluckBasename<U>> : T extends string ? PluckBasename<T> : never;
