 ...
 */
export type PluckFileExtension<T extends string> = T extends `${string}.${infer FileExtensions}` ? FileExtensions extends `${string}.${infer SubFileExtensions}` ? PluckFileExtension<`.${SubFileExtensions}`> : `.${FileExtensions}` : "";
export type FileExtensionTest1 = PluckFileExtension<"file.txt">;
export type FileExtensionTest2 = PluckFileExtension<"file.bar.min.js">;
/**
 ...
 */
export declare function extname<T extends PathBuilder | string>(path: T): T extends PathBuilder<infer U> ? PluckFileExtension<U> : T extends string ? PluckFileExtension<T> : never;
